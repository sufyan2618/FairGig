    ...
    try {
        ...
        if (existingUser) {
            ...
            if (!existingUser.isVerified) {
                ...
                try {
                    await sendEmail(email, "OTP Verification", emailTemplate);
...
export const validateToken = async (req, res) => {
    try {
        ...
        res.set('X-User-Role', req.user.role || 'user');
...
export const updatePassword = async (req, res) => {
    try {
        ...
        try {
            await sendEmail(email, "Password Changed Successfully", emailTemplate);
        } catch (error) {
