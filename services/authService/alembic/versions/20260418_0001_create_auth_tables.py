...
user_role_enum = sa.Enum("worker", "verifier", "advocate", name="user_role")
otp_purpose_enum = sa.Enum("email_verification", "password_reset", name="otp_purpose")
...
def downgrade() -> None:
    ...
    bind = op.get_bind()
    otp_purpose_enum.drop(bind, checkfirst=True)
